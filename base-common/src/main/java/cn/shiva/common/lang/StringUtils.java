package cn.shiva.common.lang;

import cn.shiva.common.codec.EncodeUtils;
import cn.shiva.common.collect.ListUtils;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 * @return 拼接字符串
	 */
	public static String appends(Serializable... serializables){
		StringBuilder sb = new StringBuilder();
		for (final Serializable s : serializables) {
			sb.append(s);
		}
		return sb.toString();
	}
	...
	public static void main(String[] args) {
		Integer i = 0;
		System.out.println(appends("MSG", "200202", String.format("%03d", ++i)));
